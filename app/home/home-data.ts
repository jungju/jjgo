export const homeCopy = {
  ko: {
    ...
    capabilityBody:
      "AI를 제품과 실제 업무에 연결하고, 팀이 반복해 만들고 운영할 수 있는 방식과 플랫폼을 설계합니다.",
    capabilities: [
      {
        number: "01",
    ...
    worksBody:
      "AI 자동화에서 서비스 주문과 배포까지, 직접 기획하고 만들고 운영한 주요 작품입니다.",
    works: [
      {
  ...
  en: {
    ...
    capabilityBody:
      "I connect AI to products and real work, and design the workflows and platforms teams need to build and operate them.",
    capabilities: [
      {
        number: "01",
        eyebrow: "AI TRANSFORMATION",
        ...
        href: "/consulting",
        action: "Explore AI Native consulting",
      },
      {
        number: "02",
        eyebrow: "AI NATIVE ORGANIZATION",
    ...
    worksBody:
      "Selected products I have designed, built, and operated—from AI automation to service ordering and delivery.",
    works: [
      {
        eyebrow: "AI CONTENT PIPELINE",
        title: "AI Slop",
