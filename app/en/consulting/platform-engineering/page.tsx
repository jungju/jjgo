...
const service = consultingServiceBySlug(
  consultingServicesEn,
...
export const metadata = pageMetadata({
  ...
  description:
    "Design internal developer platforms, CI/CD, observability, and operations with experience spanning 200+ Kubernetes clusters and 1,000+ nodes.",
  image: service.image,
  imageWidth: 1200,
  imageHeight: 800,
});
