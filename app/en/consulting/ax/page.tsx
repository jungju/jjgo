...
export const metadata = pageMetadata({
  ...
  description:
    "Evaluate AI and RAG configurations against real workflows and documents, then orchestrate models, retrieval, agents, and tools into an operational service flow.",
  image: service.image,
  imageWidth: 1200,
  imageHeight: 800,
});
